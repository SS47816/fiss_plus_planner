...
class SATCollisionChecker(object):
    def check_collision(self, ego: DynamicObstacle, obstacle: DynamicObstacle, t):
        egoPos = ego.state_at_time(t).position
        obsPos = obstacle.state_at_time(t).position
        egoPoly = copy.deepcopy(ego.obstacle_shape.vertices)
        obsPoly = copy.deepcopy(obstacle.obstacle_shape.vertices)
